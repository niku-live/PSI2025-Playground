...
A full-stack web application demonstrating CRUD operations for weather forecast management, built with ASP.NET Core (latest .NET version) backend and React frontend.
...
- **Extensive Documentation** - 11 specialized guides including AI development insights
...
All changes to this project are documented step by step [here](Docs/step-by-step.md)
...
| [**Step-by-Step Journal**](Docs/step-by-step.md) | Detailed development process from start to finish |
| [**AI Development Assistance**](Docs/can-ai-help.md) | How AI tools accelerated development with real examples |
| [**External Resources**](Docs/external-documentation.md) | Links to external documentation and additional resources |
